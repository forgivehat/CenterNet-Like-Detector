...
def add_plot_parser(subparsers):
    ...
    parser_plt.add_argument(
        ...
        type=int,
        default=1,
        help='the sample interval when plotting curves')
...
def load_json_logs(json_logs, sample_interval):
    ...
    for json_log, log_dict in zip(json_logs, log_dicts):
        with open(json_log, 'r') as log_file:
            for i, line in enumerate(log_file):
                # Skip lines based on sample interval
...
def main():
    ...
    log_dicts = load_json_logs(json_logs, args.sample_interval)
